...
# Open the necessary ports used by Kubernetes Master
sudo firewall-cmd --permanent --add-port={6443,2379,2380,10248-10252}/tcp
...
#sudo kubeadm token create hp9b0k.1g9tqz8vkf78ucwf --print-join-command